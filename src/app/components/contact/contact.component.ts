          ...
          <div class="lg:col-span-5 space-y-8">
            <div>
              ...
              <p class="text-3xl sm:text-4xl font-bold font-display text-white mb-6">
                Start Your Tech Partnership
              </p>
              <p class="text-gray-400 font-light leading-relaxed">
                Whether you need to review a quantum algorithm concept, scale model workloads, or outsource a high-performance software system, we are here to support your engineering goals.
              </p>
            </div>
            ...
            <div class="space-y-6">
              <!-- Tel -->
              <a href="tel:+18005550199" class="flex items-center p-4 rounded-xl bg-white/5 border border-white/5 hover:border-cyan-500/20 hover:bg-cyan-500/5 transition-all duration-300 group">
                ...
                <div>
                  <span class="text-[10px] font-mono text-gray-500 block uppercase">Voice Line</span>
                  <span class="text-sm font-semibold text-white group-hover:text-cyan-400 transition-colors">+1 (800) 555-0199</span>
                </div>
              </a>

              <!-- Email -->
              <a href="mailto:info&#64;quantsmind.com" class="flex items-center p-4 rounded-xl bg-white/5 border border-white/5 hover:border-cyan-500/20 hover:bg-cyan-500/5 transition-all duration-300 group">
                <div class="w-10 h-10 rounded-lg bg-cyan-500/10 text-cyan-400 flex items-center justify-center mr-4 transition-transform duration-300 group-hover:scale-110">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div>
                  <span class="text-[10px] font-mono text-gray-500 block uppercase">Email Ingestion</span>
            ...
            <div class="glass-panel border border-white/10 rounded-2xl p-8 relative overflow-hidden">
              ...
              @if (isSuccess()) {
                <div class="absolute inset-0 bg-[#08090d]/95 z-20 flex flex-col items-center justify-center p-8 text-center animate-fade-in">
                  ...
                  <h3 class="text-2xl font-bold font-display text-white mb-2">Message Ingested!</h3>
                  <p class="text-sm text-gray-400 max-w-md leading-relaxed mb-6 font-light">
                    Your request was validated and queued for routing. An engineer will follow up via the email provided within 12 business hours.
                  </p>
                  <button 
                    (click)="resetForm()"
